...
Read the full originating issue or spec and comments, linked decisions, acceptance criteria, non-goals, and the fixed diff. Check Issues #1 and #30 only where they constrain this work. Do not trust the builder's summary.
...
Run relevant acceptance tests independently when possible. Do not edit, push, merge, redesign, waive evidence, or expand scope.

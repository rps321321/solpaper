...
Write the question in a falsifiable or decision-oriented form. List the decision this research will unblock and the evidence threshold for answering it.
...
- platform and runtime fit;
- security and privacy;
- failure behavior;
- distribution or legal obligations;

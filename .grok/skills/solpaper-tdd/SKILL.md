...
- Pomodoro or domain commands and resulting views or events;
- widget-layout policy given monitor snapshots;
- persistence interfaces through temporary storage;
- Calendar projection or sync interfaces against fixtures or a mock server;
- wallpaper selection and application adapters through fakes;

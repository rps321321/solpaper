...
Read the full source plan/issue and comments, current code, `CONTEXT.md`, relevant ADRs, Issue #1, Issue #30, and existing issues that may overlap.
...
- schema, domain, adapter, UI, tests, docs, and evidence travel together when they are required for that behavior;

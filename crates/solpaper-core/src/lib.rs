...
pub use diagnostics::{
    ...
    needs_rotation_before_write, redact_user_path, runtime_recovery_plan,
    should_recommend_safe_mode, validate_log_fields, ActiveError, ActiveErrorLog, Component,
    CorrelationId, CorrelationScope, CrashMarker, DiagnosticsPathDisplay, DiagnosticsSnapshot,
    ErrorCategory, LogFileMeta, RecoveryAction, SafeModePolicy, StartupRecord, SupportCounters,
    WallpaperCycleKind, WallpaperCycleRecord, ALLOWED_LOG_FIELDS, AUTO_RESTART_ON_CRASH,
    BUNDLE_LOG_TAIL_MAX_BYTES, CRASH_LOOP_THRESHOLD, CRASH_LOOP_WINDOW_MS, FORBIDDEN_LOG_FIELDS,
    LOG_FILE_MAX_BYTES, LOG_FILE_MAX_COUNT, LOG_RETENTION_DAYS, LOG_TOTAL_MAX_BYTES,
    MAX_ACTIVE_ERRORS, REMOTE_CRASH_UPLOAD, TELEMETRY_ENABLED, WATCHDOG_PROCESS,
};
pub use layout::{
